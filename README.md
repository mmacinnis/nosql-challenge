...
This codebase contains two Jupyter Notebook files, "NoSQL_setup" and "NoSQL_analysis". 
These correspond to parts 1&2 and part 3 of the challenge, respectively.
